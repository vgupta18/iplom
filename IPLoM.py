...
class LogParser:
    ...
    def Step1(self):
        ...
        for idx, line in self.df_log.iterrows():
            line = line[self.para.header_column]#'description']#line['Content']
